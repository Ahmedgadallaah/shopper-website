...
<head>
	...
	<!--[if lt IE 9]>
		...
		<link id="ie-style" href="{{asset('backend//ie.css')}}" rel="stylesheet">
	<![endif]-->
	
	<!--[if IE 9]>
		<link id="ie9style" href="{{asset('backend//ie9.css')}}" rel="stylesheet">
	<![endif]-->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<span style=color:red;margin-left:35%>
					<?php
