			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URl::to ('/all-categories')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> ALL Categories</span></a></li>
						<li><a href="{{URL::to('/add-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="{{URl::to ('/all_brands')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a></li>
						<li><a href="{{URl::to ('/add_brand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brand</span></a></li>
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{URl::to ('/all_products')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Producrt</span></a></li>
