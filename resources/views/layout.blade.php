...
<head>
    ...
    <link href="{{URL::to('frontend/css/prettyPhoto.css')}}" rel="stylesheet">
    <link href="{{URL::to('frontend/css/price-range.css')}}" rel="stylesheet">
    <link href="{{URL::to('frontend/css/animate.css')}}" rel="stylesheet">
	<link href="{{URL::to('frontend/css/main.css')}}" rel="stylesheet">
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#sportswear">
											...
											{{$publish_categories->category_name}}
										</a>
									</h4>
								</div>
						...
						$all_published_brands=DB::table('tbl_brand')
												  ...
												  foreach($all_published_brands as $published_brands){
						?>	
									<li><a href="#"> <span class="pull-right">(50)</span>	{{$published_brands->brand_name}}</a></li>
